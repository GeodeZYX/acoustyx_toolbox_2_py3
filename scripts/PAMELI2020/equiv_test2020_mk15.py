...
Range_iTab_param = [0]                          ### weight range mono
...
for iTab_path,iTab_param,iTab_win  in itertools.product(Range_iTab_path,
                                                        Range_iTab_param,
                                                        Range_iTab_win):
    ...
    if utils.get_computer_name() == "TPX1-GFZ":
        ...
        path_computer = "/dsk/ggsp_pf/PLAYGROUND/psakicki/0000_PROJECTS_OTHERS/2009_PAMELi_GNSSA/"       
    ...
    path_obs = path_computer + "/02_PREPROCESSING/03_l/"

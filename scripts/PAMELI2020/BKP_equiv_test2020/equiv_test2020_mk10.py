...
for i_itera in range(n_itera):
    ...
    if with_direction_vectors:  
        ...
        for i_rowbea , rowbea in DFbea.iterrows():
            ...
            xrec_AHD = rowbea[cols_posi_rec_AHD].values.astype(np.float64)
...
if True:
    ...
    axhistangl.hist(Angle_residuals,50)
...
for idbea in DFbig.ID_BEA.unique():    
    ...
    axhist.hist(DFbeaplt_valid["B_TWTT"],50,density=False)
    
    axhist.hist(DictIteraStore[0]["B"],50,density=False)

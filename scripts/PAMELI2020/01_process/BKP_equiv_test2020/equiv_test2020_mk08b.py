...
# p_obs = path_obs + "PAM_BST_v231_m2507-1158_m4_d06_bea3_ITRF14_RTKLIB/PAM_BST_v231_m2507-1158_m4_d06_bea3_ITRF14_RTKLIB.csv"
...
for i_itera in range(n_itera):
    ...
    for i_idbea, idbea in enumerate(ID_bea_list):
        ...
        if fast_mode:
            ...
            DFbea.loc[Bool4Afast,['A_xbea_x','A_xbea_y','A_xbea_z','A_c']] = Afast
            DFbea.loc[Bool4Afast,"B_TWTT"] = Bfast

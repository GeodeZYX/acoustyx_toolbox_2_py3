...
PXP1 = np.array([-2500,-2500,5000])
PXP2 = np.array([2500 ,2500 ,5000])
PXP3 = np.array([-2500,2500 ,5000])
PXP4 = np.array([2500 ,-2500,5000])
    ...
    # ======================================================= 
        ...
        for prm_ipxp,prm_pxp_coords in enumerate(PXP_lis): 
            ...
            if not prm_with_ssf:
                ...
                SSPobjt = acls.SSP(Z,C)
                SSF = acls.make_SSF3D_from_SSP(SSPobjt,

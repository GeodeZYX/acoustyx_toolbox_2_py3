...
prm_SSF_based_on_interpolation                 = 1 # L'intepolation en question est celle de la pseudo munkisation
prm_SSF_based_on_interpolation_cental_SSP_ONLY = 1 # pour la création de la grille True = une SSF uniforme (avec le SSP central) et False = le SSF affecté par le gradient

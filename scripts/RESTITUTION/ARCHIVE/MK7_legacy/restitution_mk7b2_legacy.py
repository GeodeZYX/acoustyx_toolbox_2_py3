...
if platform.node() in ('calipso','finlande','diamant','VirBox5HPHP'):
    ...
    gene_path = "/home/psakicki/CODES/acoustyx_toolbox_2_py3/exemple/EXPERIMENTS/REBOOT1802/"
    ...
    for booldic , sigmadic ,seeddic    in itertools.product(booldic_lis,
        ...
        try:
            ...
            if not batch_mode:
                ...
                # Smart SSP is for operational case 
            ...
            if with_epoch_SSP:
                ...
                C_multi_epoch_list , Z_multi_epoch_list = [] , []
                ...
                for Zmonoepoch1 , Cmonoepoch1 in zip(Z_multi_epoch_list_1 , C_multi_epoch_list_1):
                    ...
                    C_multi_epoch_list.append(Cmonoepoch)
                    Z_multi_epoch_list.append(Zmonoepoch)

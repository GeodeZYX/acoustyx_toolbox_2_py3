...
import fabrik_6_fct_mk7 as fab
from   megalib import *
...
if 0:
    ...
    for boolkouran,design,ship in itertools.product(Lkouran,Ldesign,Lship):
        ...
        dico['prm_Udic_path'] = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Udic/UdicFINAL_" + ship + '.pik'
...
if 0:
    ...
    for i,itup in enumerate(ITER):
        ...
        if design == 'grand-carree':
            if ship == 'ATAL':
                Gdicpath = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALa_20_ATAL_grand-carree.pik"
            if ship == 'METEOR':
                Gdicpath = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALa_20_METEOR_grand-carree.pik"
                
        elif design == "petit-carree":
            if ship == 'ATAL':
                Gdicpath = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALa_20_ATAL_petit-carree.pik"
            if ship == 'METEOR':
                Gdicpath = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALa_20_METEOR_petit-carree.pik"

        elif design == "triangle":
            if ship == 'ATAL':
                Gdicpath = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALa_20_ATAL_triangle.pik"
            if ship == 'METEOR':
                Gdicpath = "/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALa_20_METEOR_triangle.pik"
        ...
        Gdicpath = '/home/psakicki/THESE/CODES/CodePython/acoustyx_toolbox_2/exemple/Gdic/Gdic_FINALb_10_' + ship.lower() + '_' + design + '.pik'        
...
if 1:   
    ...
    # Here we define the parameters which will change
    # And we stock them into lists
    # List with only 1 elt is possible. This element will replace the default 
    # value defined in fabrik_fct
    ...
    # Here we do the cartesian product of evry lists
    # Evry combinations with one element in each list
    ...
    for i,itup in enumerate(ITER):
        ...
        #variable parameters are added in a dico
        #1 dico = 1 run 
        # each run will be lauched with the dico 
        ...
        # midfix = custom name for the run
        midfix = 'date' + str(dat.strftime('%Y%m%d')) + '_' + design
        
        # at least the run is lauched
        fab.fabrik_fct(exp_prefix,midfix,dico)
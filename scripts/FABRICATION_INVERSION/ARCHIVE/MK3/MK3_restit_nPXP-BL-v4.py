...
if platform.node() == 'calipso':
    ...
    exp = "batc2c_deriv_decalZ_nopingnoise_trajnoisedecim_5000_R50_noisFalse-0__"

    exp = 'batc2c_deriv_decalZ_nopingnoise_5000_R50_noisFalse-0__'
    
    exp = 'batc3b_2000_bw_deriv_decalZ_5000_R50_noisTrue-1e-06__'
    exp = 'batc3a_1000_bw_deriv_decalZ_5000_R50_noisTrue-1e-06__'
...
if not multiexp_mode:
    ...
    exp_lis = ["batc2c_deriv_decalZ_5000_R50_noisTrue-1e-06__" ,
               'batc2c_deriv_decalZ_nopingnoise_5000_R50_noisFalse-0__',
               "batc2c_deriv_decalZ_noping_notraj_noise_5000_R50_noisFalse-0__"]
...
for exp in exp_lis:
    ...
    for booldic in booldic_lis:
        try:
            ...
            noise4PXPdZ = np.random.RandomState(1789).randn(4) * 0.001
...
#            while np.linalg.norm(PXPapri - PXPold) > 5 * 10**-5 and iiter <= iitermax:
            ...
            #while np.linalg.norm(kriter - kriterold) > 10**-4:
                ...
                if with_zmaster:
                    ...
                    nz = len(PXPdZ_lis)
                    JacobZ = np.hstack((np.zeros((nz,JacobASM.shape[1] - nz)) , np.diag(np.ones((nz,nz))[:,0])))
